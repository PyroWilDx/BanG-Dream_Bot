    ...
    while True:
        ...
        if len(index_nonZero_list) > 0:
            if all(value <= 2 for value in index_nonZero_list):
                ...
                while True:
                    screen = grab_screen(region=(150, 370, 790, 400))
...
def home_to_game():
    ...
    if song_choice_var == 1:
        ...
        while pyautogui.locateOnScreen("full_combo_star.png", region=(x1, 267, 27 + width, 28),
                                       confidence=0.75) is not None \
                or pyautogui.locateOnScreen("full_perfect_star.png", region=(x1, 267, 27 + width, 28),
                                            confidence=0.75) is not None:
        ...
        while pyautogui.locateOnScreen("full_perfect_star.png", region=(x1, 267, 27 + width, 28),
                                       confidence=0.75) is not None:
        ...
        if played != 0:
            if pyautogui.locateOnScreen("full_combo_star.png", region=(351, 267, 28, 28), confidence=0.75) is not None \
                    or pyautogui.locateOnScreen("full_perfect_star.png", region=(351, 267, 28, 28),
                                                confidence=0.75) is not None:
                print("This song is already full-comboed, selecting next song...")
                pyautogui.moveTo(250, 320)
                pyautogui.dragTo(250, 240, duration=1)
